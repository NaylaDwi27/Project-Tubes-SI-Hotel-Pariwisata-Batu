...
<head>
    ...
    <title>Login | SI Pariwisata dan Hotel Kota Batu</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text text-body fw-bolder">SI Pariwisata dan Hotel Kota
                                    Batu</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang 👋</h4>
                        <p class="mb-4">Silakan sign in untuk melanjutkan</p>
                        ...
                        <?php endif ?>
                        <form id="formAuthentication" class="mb-3" action="{{ url('check_login') }}"
                            method="POST">
                            {{ csrf_field() }}
                            <div class="mb-3">
