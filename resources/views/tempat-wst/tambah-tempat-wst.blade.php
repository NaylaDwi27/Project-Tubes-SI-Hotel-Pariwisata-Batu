...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('tempat-wst.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="id_jenis_wisata" id="id_jenis_wisata" required>
                            @foreach ($jenis as $j)
                                <option value="{{ $j->id_jenis_wisata }}">
                                    {{ $j->nama }}
                                </option>
                            @endforeach
                        </select>
